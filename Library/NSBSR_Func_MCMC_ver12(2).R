...
Predict_NSBSR = function(mcmcobj,Esti.summary,simdata){
  ...
  # corr = Re(fftw2d(mat.lambda,inverse=1))
  corr1 = Re(fftw2d(mat.lambda,inverse=1))
  corr  = 0.05*corr1 + 0.95*corr2
  ...
  curr.obj <- list( x=seq(0,(simdata$D[1]-1),by=simdata$d[1]), y=seq(0,(simdata$D[2]-1),by=simdata$d[2]), z= corr2 )
