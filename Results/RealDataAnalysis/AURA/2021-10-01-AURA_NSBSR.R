...
rho.vec  = exp(seq(log(1e-05),log(1e-03),length.out=5))
...
null.mcmcobj.list = SetMCMC(seed=100,nd=nd,n.chain=1,n.iter=10,n.burn=0)
...
par(mfrow=c(2,2))
fields::image.plot(O3L3.full,zlim=c(270,350))
fields::image.plot(pred.NSBSR,zlim=c(270,350))
