...
# pdf(paste0("THESIS_Results/Result4/",Sys.Date(),"MODIS_FIG1.pdf"),width=7*1.2.5,height=7*1.5)
colindex = rainbow(77,alpha=0.5)
brk = (seq(-4.5,4,length.out=78))
# par(mfrow=c(2,2))

pdf(paste0("THESIS_Results/Result4/",Sys.Date(),"Figure4_1_1.pdf"),width=7*1.2,height=7*1)
par(mfrow=c(1,1),mar=c(3,3,1,5))
x = seq(112,141,by=1);y = 28/28*(x-113)+25
plot(x,y,type="n",xlab="",ylab="",main="",xaxt='n',yaxt='n',xlim=c(112.5,140.5),ylim=c(25,52))
...
pdf(paste0("THESIS_Results/Result4/",Sys.Date(),"Figure4_1_2.pdf"),width=7*1.2,height=7*1)
par(mfrow=c(1,1),mar=c(3,3,1,5))
...
pdf(paste0("THESIS_Results/Result4/",Sys.Date(),"Figure4_1_3.pdf"),width=7*1.2,height=7*1)
par(mfrow=c(1,1),mar=c(3,3,1,5))
x = seq(112,141,by=1);y = 28/28*(x-113)+25
sc = mean(t(mylist[[1]])[2:30,2:30] - t(temp3),na.rm=T)^2
r2 = summary(lm(as.vector(t(mylist[[1]])[2:30,2:30]) ~ as.vector(t(temp3))))$r.squared
plot(x,y,type="n",xlab="",ylab="",main="",xaxt='n',yaxt='n',xlim=c(113,140),ylim=c(25.5,52.5))
title(xlab="lon",ylab="lat",line=2)
axis(side=1,at=seq(115,141,by=5),labels=seq(115,141,by=5),line=-0.5,tick=FALSE)
axis(side=2,at=seq(25,53,by=5),labels=seq(25,53,by=5),line=-0.5,tick=FALSE)
...
pdf(paste0("THESIS_Results/Result4/",Sys.Date(),"Figure4_1_4.pdf"),width=7*1.2,height=7*1)
par(mfrow=c(1,1),mar=c(3,3,1,5))
x = seq(112,141,by=1);y = 28/28*(x-113)+25
sc = mean(t(mylist[[1]])[2:30,2:30] - t(temp3),na.rm=T)^2
r2 = summary(lm(as.vector(t(mylist[[1]])[2:30,2:30]) ~ as.vector(t(temp3))))$r.squared
...
# pdf(paste0("THESIS_Results/Result4/",Sys.Date(),"MODIS_FIG2.pdf"),width=7*1.2.5,height=7*1.5)

# par(mfrow=c(2,2))
colindex = rainbow(77,alpha=0.5)
brk = (seq(-4.5,4,length.out=78))

pdf(paste0("THESIS_Results/Result4/",Sys.Date(),"Figure4_2_1.pdf"),width=7*1.2,height=7*1)
par(mfrow=c(1,1),mar=c(3,3,1,5))
x = seq(112,141,by=1);y = 28/28*(x-113)+25
plot(x,y,type="n",xlab="",ylab="",main="",xaxt='n',yaxt='n',xlim=c(113,140),ylim=c(25.5,52.5))
title(xlab="lon",ylab="lat",line=2)
...
pdf(paste0("THESIS_Results/Result4/",Sys.Date(),"Figure4_2_2.pdf"),width=7*1.2,height=7*1)
par(mfrow=c(1,1),mar=c(3,3,1,5))
...
pdf(paste0("THESIS_Results/Result4/",Sys.Date(),"Figure4_2_3.pdf"),width=7*1.2,height=7*1)
par(mfrow=c(1,1),mar=c(3,3,1,5))
x = seq(112,141,by=0.5);y = 28/28*(x-113)+25
plot(x,y,type="n",xlab="",ylab="",main="",xaxt='n',yaxt='n',xlim=c(113,140),ylim=c(25.5,52.5))
title(xlab="lon",ylab="lat",line=2)
...
pdf(paste0("THESIS_Results/Result4/",Sys.Date(),"Figure4_2_4.pdf"),width=7*1.2,height=7*1)
par(mfrow=c(1,1),mar=c(3,3,1,5))
x = seq(112,141,by=0.5);y = 28/28*(x-113)+25
plot(x,y,type="n",xlab="",ylab="",main="",xaxt='n',yaxt='n',xlim=c(113,140),ylim=c(25.5,52.5))
title(xlab="lon",ylab="lat",line=2)
